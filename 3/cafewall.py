...
# Program: Cafe Wall
#
# This draws several rows of black and white boxes, as well as several
# examples of the Cafe Wall illusion.
...
# --------------------------------------------------------------------
# box() draws a box of a particular color. If it is a black box it
# will also add a blue 'X'
#
...
def box(panel, x, y, size, color):
    panel.canvas.create_rectangle(x, y, x + size, y + size,
...
# --------------------------------------------------------------------
def draw_grid(panel, rows, row_length, x_start, y_start, box_size,
              offset):
    for row in range(1, rows + 1):
        if ((row % 2 == 0) and offset > 0):
            ...
            x_start = x_start - offset
        draw_row(panel, row_length, x_start, y_start, box_size,
                 offset)
